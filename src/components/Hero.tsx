...
// import Banner from "@/assets/DipDips Banner-.jpg";
...
//       {/* ✅ Banner Section */}
//       <section
//         className="relative w-full h-[370px] mt-16 pt-0 bg-cover bg-center bg-no-repeat"
//         style={{ backgroundImage: `url(${Banner})` }}
//       ></section>

//       {/* ✅ Content Section */}
//       <section className="w-full bg-white m-0 p-0">
//         <section className="relative z-10 bg-black py-20 text-center">
...
//               We prepare healthy food that is ready to eat. Choose your favorite menu and enjoy fresh, delicious meals ready for pickup.
//             </p>
      ...
      <section className="w-full bg-white py-20">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-2xl mx-auto text-center">
            ...
            <div>
              <div className="text-3xl lg:text-4xl font-bold text-black mb-2">50K+</div>
            ...
            <div>
              <div className="text-3xl lg:text-4xl font-bold text-black mb-2">25+</div>
              <div className="text-gray-600 text-sm uppercase tracking-wide">
                Cities Served
              </div>
            </div>
            ...
            <div>
              <div className="text-3xl lg:text-4xl font-bold text-black mb-2">100+</div>
              <div className="text-gray-600 text-sm uppercase tracking-wide">
                Healthy Dishes
              </div>
            </div>
